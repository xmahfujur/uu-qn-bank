...
export default function App() {
  ...
  // Active View router
  const [activeView, setActiveView] = useState<'landing' | 'dashboard' | 'profile' | 'admin' | 'leaderboard'>('landing');
        ...
        <div className="relative min-h-[70vh]">
          ...
          {selectedQuestionId ? (
            ...
            <>
              ...
              {activeView === 'admin' && currentUser && currentUser.role === 'super_admin' && (
                <AdminPanel
                  currentUser={currentUser}
                  onNavigateToQuestion={(id) => setSelectedQuestionId(id)}
                />
          ...
          {currentUser && activeView !== 'landing' && !selectedQuestionId && (
            <button
