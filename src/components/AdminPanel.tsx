                      ...
                      <tr key={q.id} className="hover:bg-slate-50/55 dark:hover:bg-slate-900/30 transition-colors">
                        ...
                        <td className="p-4 text-right space-x-2">
                          <button
                            ...
                            className="p-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-lg text-slate-700 dark:text-slate-300 transition-colors"
                            title="View paper"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-950/60 text-red-600 rounded-lg transition-colors"
