...
export default function QuestionDetail({ 
  ...
  async function handleDownload() {
    ...
    window.open(question.pdfUrl || question.imageUrl, '_blank');
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-900 p-4 sm:p-6 shadow-sm">
            ...
            {/* Main view container */}
            <div className="flex items-center justify-center bg-slate-50 dark:bg-slate-900/40 rounded-xl overflow-hidden border border-slate-200/50 dark:border-slate-800/50 min-h-[400px]">
              <img 
                src={currentImgUrl} 
          ...
          <div className="bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-200 dark:border-slate-900 shadow-sm space-y-6">
            ...
            <div className="border-t border-slate-100 dark:border-slate-900/85 pt-4 space-y-3 text-sm text-slate-600 dark:text-slate-400">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-slate-800 dark:text-slate-200">Final Category</span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-2 pt-2">
              <button
                ...
                className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold flex items-center justify-center gap-2 shadow-md shadow-indigo-600/15 transition-all"
              >
