...
export default function QuestionDetail({ 
  ...
  const currentImgUrl = pages[activeImageIndex] || formatImageUrl(question.imageUrl);
            ...
            >
              <img 
                ...
                onError={(e) => {
                  ...
                  // If lh3 fails, try google drive export fallback or direct placeholder
                  ...
                  target.src = 'https://placehold.co/800x1200/1e293b/ffffff?text=Unable+to+Load+Question+Paper';
                }}
              />
            ...
            <div className="space-y-2 pt-2">
              ...
              {(currentUser?.role === 'super_admin' || currentUser?.role === 'moderator' || currentUser?.uid === question.uploadedByUID) && (
                <button
                  ...
                  className="w-full py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-colors border border-slate-200/50 dark:border-slate-800"
                >
